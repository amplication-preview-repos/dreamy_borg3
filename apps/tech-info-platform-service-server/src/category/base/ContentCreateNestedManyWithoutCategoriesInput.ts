...
@InputType()
class ContentCreateNestedManyWithoutCategoriesInput {
...
export { ContentCreateNestedManyWithoutCategoriesInput as ContentCreateNestedManyWithoutCategoriesInput };
